...
const MEMORIES = [
  {
    id: 1,
    front: "🤫  A secret",
    back: "Kya hi secret expect kar rahe hai ap hamse! ham toh ek khuli kitab hai, you know it. Par haan ham kabhi kisi ke texts dobara read nahi karte, but for you I did. I mean, in case of yours. So yeah, I really appreciate that I have you.",
  ...
  },
  {
    id: 2,
    front: "✨  A truth",
    back: "Agar truth likhna hi hai… toh yeah, I like you as a person. apki presence kaafi genuine lagti hai, and that means a lot kyunki same vibe wale insan milna in todays era is not muskil but i  found this out after abhi bas last yr ki diwali me(for your context tab hi hamari baat shuru hui thi).",
  ...
  },
  {
    id: 3,
    front: "🎭  A confession",
    back: "Confession hai… I like you as a person. ap ache lagte ho, inside and outside—yeah, you look really good too. Bas itna hi, but it means more than it sounds.",
  ...
  },
  {
    id: 4,
    front: "💌  A wish",
    back: "I was gonna get you the best gift… but then I realized you already have me wishing you.............hehehe",
  ...
  },
  {
    id: 6,
    front: "🔮  A prediction",
    back: "ap aur zyada popular hone wale ho,aur bhi kaafi side chicks bhi aa sakti hain (crossing my fingers ki na aaye 🤞). But I think I’ll still stand out",
